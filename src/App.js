  ...
  render() {
    return (
      <div className="App">
        <NavBarHeader />
        <Switch>
          <Route exact path="/" render={() => <AllBanks favourites={this.state.favourites} isLoading={this.state.isLoading} toogle={this.toogle} rowData={this.state.rowData} changeCity={this.changeCity} changeCategory={this.changeCategory} changeSearch={this.changeSearch} city={this.state.city} category={this.state.category} searchTerm={this.state.searchTerm} />} />
